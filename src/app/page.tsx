  ...
  const handleAddClient = (e: React.FormEvent) => {
    ...
    try {
      const clientToAdd: Client = {
        ...
        spouse_name: newClient.spouse_name || undefined,
        spouse_date_of_birth: newClient.spouse_date_of_birth || undefined,
        home_value: newClient.home_value,
        desired_proceeds: newClient.desired_proceeds,
        loan_officer: newClient.loan_officer,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-400 via-emerald-400 to-blue-500 animate-gradient relative overflow-hidden">
      ...
      <style jsx>{`
        ...
        .animate-gradient {
          background: linear-gradient(-45deg, #3b82f6, #10b981, #06b6d4, #059669);
