...
// Client interface with address fields added
interface Client {
  id: string
  first_name: string
  last_name: string
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-400 via-emerald-400 to-blue-500 animate-gradient relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        {/* Client Cards with Address Display */}
      ...
      {/* Add Client Modal with Address Fields */}
      {showAddModal && (
      ...
      {/* Client Detail Modal with Address Display */}
