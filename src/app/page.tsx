...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5tY3FsZWtweXFmZ3l6b2VsY3NhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjQzNjEwNjUsImV4cCI6MjAzOTkzNzA2NX0.C1_gVBu0VrV7KEWKlrTGNJvcsaVkd3BsKJTw_ZCVU5Q'
...
// MAIN CRM COMPONENT (Your existing CRM - UNCHANGED)
const MainCRM = ({ user, onLogout }: { user: any, onLogout: () => void }) => {
  // All your existing CRM state and logic
...
export default function ProtectedNextStepCRM() {
  ...
  // Show main CRM if authenticated
  return <MainCRM user={user} onLogout={handleLogout} />
}4">Loan Information</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Program Type</label>
                      <select
